...
def get_device_list():
    ...
    """
    Apply a filter to the data and look for a specific device by creating a query string
    variable queryString and passing the variable part of the params parameter
    in your requests.get call. 
    """
...
#Make sure you write the get_auth_token() function that is referenced for both the GET request and the later filtering.
def get_auth_token():
    """
